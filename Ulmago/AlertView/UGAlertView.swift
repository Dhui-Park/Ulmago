...
//  Ulmago
//
//  Created by dhui on 4/10/24.
//

import Foundation
import UIKit

class UGAlertView: UIView {
    ...
    weak var delegate: UGAlertViewDelegate?
    ...
    init(title: String? = nil, message: String? = nil, buttonTitles: [String], boldButtonIndex: Int = 0) {
        super.init(frame: CGRect(x: 0, y: 0, width: kDefaultWidth, height: kDefaultHeight))
        
        setUp(title: title, message: message, buttonTitles: buttonTitles, boldButtonIndex: boldButtonIndex)
    ...
    // handle events
    @discardableResult
    public func onButtonClicked(_ handler: @escaping (_ alertView: UGAlertView, _ buttonIndex: Int) -> Void) -> UGAlertView {
    ...
    @discardableResult
    public func onActionButtonClicked(_ handler: @escaping (_ alertView: UGAlertView, _ buttonIndex: Int) -> Void) -> UGAlertView {
    ...
    @discardableResult
    public func onTextChanged(_ handler: @escaping (_ alertView: UGAlertView, _ text: String?, _ textFieldIndex: Int) -> Void) -> UGAlertView {
...
extension UGAlertView {

    private func setUp(title: String? = nil,
                       message: String? = nil,
                       contentView: UIView? = nil,
                       buttonTitles: [String],
                       boldButtonIndex: Int = 0) {
        self.title = title
        ...
        setUpDefaultValue()
        setUpElements(boldButtonIndex: boldButtonIndex)
...
//    fileprivate func applyButtonTitle(_ index: Int, _ boldButtonIndex: Int, _ buttonTitle: String, _ button: inout _HighlightButton) {
//        if index == boldButtonIndex {
//            let boldString = NSAttributedString(string: buttonTitle, attributes: [.font : UIFont.boldSystemFont(ofSize: 30)])
//            
//            button.setAttributedTitle(boldString, for: .normal)
//        } else {
//            button.setTitle(buttonTitle, for: .normal)
//        }
//    }
//    fileprivate func applyButtonTitle(_ index: Int, _ boldButtonIndex: Int, _ buttonTitle: String, _ button: _HighlightButton) -> _HighlightButton {
//        var button = button
//        if index == boldButtonIndex {
//            let boldString = NSAttributedString(string: buttonTitle, attributes: [.font : UIFont.boldSystemFont(ofSize: 30)])
//            
...
//    }
    ...
    private func setUpElements(boldButtonIndex: Int = 0) {
        ...
        for (index, buttonTitle) in buttonTitles.enumerated() {
            ...
            let button = _HighlightButton(isBold: index == boldButtonIndex, buttonTitle: buttonTitle)
...
//            
//            if buttonTitle == buttonTitles[boldButtonIndex] {
//                let boldString = NSAttributedString(string: buttonTitle, attributes: [.font : UIFont.boldSystemFont(ofSize: 30)])
//                
//                button.setAttributedTitle(boldString, for: .normal)
//                
...
//    @discardableResult
    public static func show(title: String? = nil,
                            ...
                            buttonTitles: [String],
                            boldButtonIndex: Int = 0,
                            configure: ((_ alertView: UGAlertView) -> Void)? = nil) -> UGAlertView {
        let alertView = UGAlertView(title: title, message: message, buttonTitles: buttonTitles, boldButtonIndex: boldButtonIndex)
        configure?(alertView)
        alertView.show()
        return alertView
    }
    ...
    public static func show(contentView: UIView,
                            buttonTitles: [String],
                            configure: ((_ alertView: UGAlertView) -> Void)? = nil) -> UGAlertView {
        let alertView = UGAlertView(contentView: contentView, buttonTitles: buttonTitles)
        configure?(alertView)
        alertView.show()
        return alertView
    }
    ...
    public static func show(nibName: String,
                            buttonTitles: [String],
                            configure: ((_ alertView: UGAlertView) -> Void)? = nil) -> UGAlertView {
        let alertView = UGAlertView(nibName: nibName, buttonTitles: buttonTitles)
        configure?(alertView)
        alertView.show()
        return alertView
    }
...
@objc protocol UGAlertViewDelegate : NSObjectProtocol {

    @objc optional func alertView(_ alertView: UGAlertView, clickedButtonAtIndex buttonIndex: Int)
    
    @objc optional func willPresentAlertView(_ alertView: UGAlertView) // before animation and showing view
    @objc optional func didPresentAlertView(_ alertView: UGAlertView) // after animation
    
    @objc optional func willDismissAlertView(_ alertView: UGAlertView) // before animation and showing view
    @objc optional func didDismissAlertView(_ alertView: UGAlertView) // after animation
}

extension UGAlertView: UITextFieldDelegate {
...
final class _HighlightButton: UIButton {
    ...
    convenience init(isBold: Bool, buttonTitle: String, size: CGFloat = 17) {
        ...
        if isBold {
            let boldString = NSAttributedString(string: buttonTitle, attributes: [.font : UIFont.boldSystemFont(ofSize: size)])
